...
export const send_pre_launch_vip_1_email = async (contact_email: string) => {
    ...
    const unsubscribe_payload = redirect_payload_schema.parse({
        ...
        utm_params: {
            utm_source: 'email',
            utm_campaign: EMAIL_TEMPLATES.PRE_LAUNCH_VIP_1,
    ...
    const smtp2go = {
        headers: {
            'X-Category': EMAIL_TEMPLATES.PRE_LAUNCH_VIP_1,
        },
    }
