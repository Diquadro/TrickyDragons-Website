...
export function initialize_mixpanel() {
    // Avoid multiple initializations
    if (window.mixpanel) return // Standard Mixpanel initialization code
    ;(function (e, c) {
        if (!c.__SV) {
            var l, h
            window.mixpanel = c
    ...
    let mixpanelToken
    if (ENV.PRODUCTION) {
        mixpanelToken = 'c59cd1004944ea21c7c22637ebcc4552'
    } else if (ENV.DEVELOPMENT) {
        mixpanelToken = '94b951347ffa2f331f91978397b8e72b'
    }
