...
// EXTERNAL MODULE: ./src/www/scripts/costants.ts
var costants = __webpack_require__(456);
...
var landingpage_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var landingpage_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g = Object.create((typeof Iterator === "function" ? Iterator : Object).prototype);
    return g.next = verb(0), g["throw"] = verb(1), g["return"] = verb(2), typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
function handle_redirect() {
    var _this = this;
    var redirectLinks = document.querySelectorAll('.redirect_link');
    redirectLinks.forEach(function (link) {
        link.addEventListener('click', function (event) { return landingpage_awaiter(_this, void 0, void 0, function () {
            var anchor, data, base64Data;
            return landingpage_generator(this, function (_a) {
                event.preventDefault();
                anchor = link;
                data = JSON.stringify({
                    origin: 0,
                ...
                base64Data = btoa(data) // Base64 URL-safe
                ;
                fetch("".concat(costants/* API_URL */.H, "/redirect/").concat(base64Data)).catch(function (error) {
